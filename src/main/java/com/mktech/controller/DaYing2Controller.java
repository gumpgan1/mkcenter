...
@Controller
@RequestMapping(value = "/daying2")
public class DaYing2Controller {
...
//		System.out.println(request.getContextPath());   /mkcenter
		List<Map<String, Object>> list = dbDaying2Service.selectLatestRecord100();
		...
		public String getNew(HttpServletRequest request,
			...
			String result = null;		
			List<Map<String, Object>> list = dbDaying2Service.selectLatestRecord();
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("list", list);
			Gson gson = new Gson();
			result = gson.toJson(map);
		...
		//获取业务信息
				...
				public String getJYIntoYewu(HttpServletRequest request,
										HttpServletResponse response) throws IOException {
					List<Map<String, Object>> list = dbDaying2Service.initYewu();
					Map<String, Object> map = new HashMap<String, Object>();
					map.put("list", list);
					Gson gson = new Gson();
				...
				public String getLatest(HttpServletRequest request,
					...
					List<Map<String, Object>> list = dbDaying2Service.updateLatestByWeek(timestamp);
					Map<String, Object> map = new HashMap<String, Object>();
					map.put("list", list);
					Gson gson = new Gson();
					String result = gson.toJson(map);
				...
				public String updateJyIntoYewu(HttpServletRequest request,
					...
					List<Map<String, Object>> list = dbDaying2Service.updateYewu(start+8*3600*1000, end+8*3600*1000);
					Map<String, Object> map = new HashMap<String, Object>();
					map.put("list", list);
					Gson gson = new Gson();
					String result = gson.toJson(map);
				...
				public String getRange(HttpServletRequest request,
					...
					String result = null;		
					List<Map<String, Object>> list = dbDaying2Service.selectRange();
					Map<String, Object> map = new HashMap<String, Object>();
					map.put("list", list);
					Gson gson = new Gson();
					result = gson.toJson(map);
				...
				public String selectRange(HttpServletRequest request,
										...
										@RequestParam("start") long start,
										@RequestParam("end") long end) throws IOException {
					List<Map<String, Object>> list = dbDaying2Service.selectDataByRange(start+8*3600*1000, end+8*3600*1000);
					Map<String, Object> map = new HashMap<String, Object>();
					map.put("list", list);
					Gson gson = new Gson();
					String result = gson.toJson(map);
