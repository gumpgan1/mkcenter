	...
	$.ajax({
	    	...
	    	success:function(data){
	    		...
	    		for(var key in json.list){
	    			...
	    			//每小时产量
					//var y1 = (json.list[key].L0002+json.list[key].L0005+json.list[key].L0008);	
					//lw.series[0].addPoint([x,y1],true,true);
...
function addPoint(){
	$.ajax({
		...
		success:function(data){
			...
			for(var key in json.list){
				var x = json.list[key].TIMESTAMP-8*3600*1000;
				var y = (json.list[key].L0002+json.list[key].L0005+json.list[key].L0008)*0.92;
	...
	$.ajax({
	    	...
	    	success:function(data){
	    		...
	    		for(var key in json.list){
	    			...
	    			/*initData.push({
	    				x : json.list[key].TIMESTAMP-3600*1000*8,
						y : (json.list[key].L0002+json.list[key].L0005+json.list[key].L0008)*0.92
	    			});*/
	    		}
	    		//console.log(splData);
